...
// Aframe3_base_bottom2(l2,theta1,l7,theta2,t4,h,r5,r4);

//rounded_triangle3(theta2,l7,8,16,4);
//translate([l7*cos(theta2/2),0,0])mirror()rounded_triangle3(theta2,l7/2,6,16,3);




//Aframe();
Aframe3_bottom(l2,theta1,l7,theta2,t4,h,r5,r4);
...
union()
{
translate([0,0,+h/2+2*t4])cylinder(20,15,15,center=true);
translate([0,0,+h/2+t4])mirror()rounded_triangle3(theta1,l2,10,2*t4,5);
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle3(theta2,l7,16,2*t4,5);
translate([-(r4+4+4)-8,0,h/2+2*t4])cube(size=[68,48,2*t4],center=true);
//translate([0,0,+h/2+t4])mirror()rounded_triangle_holes(theta1,l2,r5,2*t4,14);
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4+0.5])rounded_triangle_holes(theta2,l7/2,14,2*t4-1,8);

}//end union/////////////////////

translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle_holes(theta2,l7/2,14,2*t4,5);

translate([0,0,+h/2+t4])mirror()rounded_triangle_holes(theta1,l2,r5,2*t4,5);
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle_holes(theta2,l7,14,2*t4,11);

//booker rod hole
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4-4])rounded_triangle_holes(theta2,l7,14,2*t4,12);
...
//stepper mount hole
translate([-(r4+4+4)-8,0,h/2+2*t4+3])cube(size=[64,44,2*t4],center=true);
//stepper m3 holes
...
translate([0,0,+h/2+t4])mirror()rounded_triangle3(theta1,l2,10,2*t4,5);
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle3(theta2,l7,16,2*t4,5);
translate([-(r4+4+4),0,h/2+2*t4])cylinder(2*t4,14,14,center=true);
//translate([0,0,+h/2+t4])mirror()rounded_triangle_holes(theta1,l2,r5,2*t4,14);
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4+0.5])rounded_triangle_holes(theta2,l7/2,14,2*t4-1,8);

translate([-(r4+4+4)-20,0,h/2+2*t4])beam(l7*cos(theta2/2),2*t4,8,6,2);
...
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle_holes(theta2,l7,14,2*t4,11);
//nutcapture M8
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,h+6])hexagon(13,8);
//M8 hole
...
//nutcapture M8
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,h/2+12])hexagon(13,8);
//M8 hole
//translate([-l2*cos(theta1/2)-l7*cos(theta2/2)/2+r5*cos(theta2/2)/2,0,h/2+10])cylinder(2*t4+1,4.5,4.5,center=true);
//booker rod hole
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,0])cylinder(200,5,5,center=true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
module Aframe3_base_bottom2(l2,theta1,l7,theta2,t4,h,r5,r4){
...
translate([-l2*cos(theta1/2)-l7*cos(theta2/2),0,+h/2+t4])rounded_triangle3(theta2,l7,8,20,4);
translate([-l2*cos(theta1/2),0,+h/2+t4])mirror()rounded_triangle3(theta2,l7/2,7,20,3);
//stepper housing
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,h/2+2*t4])cube(size=[49,49,20],center=true);
}


translate([-l2*cos(theta1/2),0,+h/2+t4])mirror()rounded_triangle_holes(theta2,l7/2,6,20,3);
...
//stepper mount hole
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,h/2+2*t4])cube(size=[44,44,24],center=true);
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-45,0,h/2+2*t4])cube(size=[10,8,24],center=true);
...
translate([-l2*cos(theta1/2),0,+h/2+t4+0.5])mirror()rounded_triangle_holes(theta2,l7/2,6,8,3);
...
translate([-l2*cos(theta1/2),0,+h/2+t4])mirror()rounded_triangle_holes(theta2,l7/2,6,20,3);
translate([-l2*cos(theta1/2),0,+h/2+t4-3])mirror()rounded_triangle_hexagons(theta2,l7/2,6,8,8);
...
//stepper mount hole
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-25,0,h/2+2*t4+4])cube(size=[44,44,24],center=true);
translate([-l2*cos(theta1/2)-1*l7*cos(theta2/2)/3-45,0,h/2+2*t4])cube(size=[10,8,24],center=true);
//stepper m3 holes
