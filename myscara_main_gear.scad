...
translate([0,0,0])cube(size=[18,2*r1,h+1],center=true);
translate([r1-21,0])cube(size=[12,90,h+1],center=true);
}
//cylinder(h,r1-t,r1-t,center=true);

//stepper cut outs
translate([12,0,0])cube(size=[10,40,39],center=true);
translate([0,0,0])rotate([0,90,0])cylinder(20,13,13,center=true);
translate([0,16,16])rotate([0,90,0])cylinder(20,2,2,center=true);
translate([0,16,-16])rotate([0,90,0])cylinder(20,2,2,center=true);
translate([0,-16,16])rotate([0,90,0])cylinder(20,2,2,center=true);
translate([0,-16,-16])rotate([0,90,0])cylinder(20,2,2,center=true);
...
//nut captures
translate([0,0,15])hexagon(12,8);
translate([0,0,-15])rotate([0,0,90])hexagon(12,8);
//axle cut
cylinder(100,4,4,center=true);
//axle2 cut
translate([r1-10,0,0])rotate([0,90,0])cylinder(20,6,6,center=true);
translate([r1-24,0,0])rotate([0,90,0])cylinder(8,11.3,11.3,center=true);

//bearing axle2
translate([-stepper_l/2-8,0,0])cube(size=[stepper_l+2,stepper_w+1,stepper_w+10],center=true);
